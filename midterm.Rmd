...
Hint: The PDF of a Uniform(a, b) distribution is `dunif(..., min = a, max = b)`.
...
Define a function `dunif2` that accepts the arguments `x`, `min`, `max`, and behaves exactly like `dunif`.
