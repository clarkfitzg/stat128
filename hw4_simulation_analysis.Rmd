...
set.seed(8913) # Starts the random number generator at a particular place, so the graph will look the same for everyone.
ntimes = 20
...
> `doublebet` implements the basic martingale doubling strategy (very inefficiently 😬, but that's fine).
