...
Define a vectorized function `single` that accepts `x`, a sample vector, and `d`, a digit between  1 and 36, and returns the amount you win or lose in roulette if you bet one 
